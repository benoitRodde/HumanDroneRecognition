...
def _main():
    ...
    early_stopping = EarlyStopping(monitor='val_loss', min_delta=0.0001, patience=10, mode="min", verbose=1, restore_best_weights=True)
    ...
    if True:
        ...
        batch_size = 32
        print('Train on {} frames, validation on {} frames, with batch size {}.'.format(num_train, num_val, batch_size))
